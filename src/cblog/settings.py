...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/omercan/capstone/username')
    password_param = ssm.get_parameter(Name="/omercan/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.cih7kc86h9uy.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'omercan-cap-static' # please enter your s3 bucket name
